...
eunit: 
	...
	erlc -I ../rd/include -I /home/joq62/erlang/include -o test_ebin ../rd/src/*.erl;
	cp ../rd/src/rd.app.src test_ebin/rd.app;
	erlc -I ../log/include -I /home/joq62/erlang/include -o test_ebin ../log/src/*.erl;
